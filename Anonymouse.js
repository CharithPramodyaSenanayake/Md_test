...
{      
 ...
 Anony.sendMessage(m.chat, { react: { text: "👥", key: m.key }})
...
//about
case 'about': {
	Anony.sendMessage(m.chat, { react: { text: "❤️", key: m.key }})
	reply('comming soon 🔐')
	}
break
            ...
            const {
              nowatermark,watermark,audio,Avatar,botname,type,
                ...
                let buttonMessage = {
                    document: { url: audio },
                    mimetype: 'audio/mpeg', 
                    fileName: `Anony-Tik-tok-Downloader.mp3`,
                    caption: `${type}
...
Select Your Type Of Video Or Audio`,
	...
	case 'play': case 'song': case 'video': case 'yt': {
		Anony.sendPresenceUpdate('composing', m.chat) 
